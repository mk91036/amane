...
module.exports.run = async (bot, message, args) => {
    ...
    if (command[1] == undefined) {
        if (message.author.id === config.ownerID) {
            ...
            .addField('Phantasy Star Online 2 Command', `**${config.prefix}error** | **${config.prefix}builds** | **${config.prefix}eqall** | **${config.prefix}candy** | **${config.prefix}status** | **${config.prefix}item** | **${config.prefix}daily**`)
